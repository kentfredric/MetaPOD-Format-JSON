...
eval { $v .= pmver('MetaPOD::Assembler','any version') };
eval { $v .= pmver('MetaPOD::Exception::Decode::Data','any version') };
eval { $v .= pmver('MetaPOD::Extractor','any version') };
eval { $v .= pmver('MetaPOD::Result','any version') };
eval { $v .= pmver('MetaPOD::Role::Format','any version') };
